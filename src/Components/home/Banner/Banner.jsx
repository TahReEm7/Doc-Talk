...
const Banner = () => {
    return (
        <div className='text-center w-11/12 mx-auto shadow-4xl border-4 border-white bg-base-300 rounded-2xl  py-10'>
            ...
            <div className='flex gap-3 justify-center items-center'>
                <img className='h-90' src="https://i.ibb.co.com/TxWKPGZL/banner-img-1.png" alt="image" />
                <img className='h-90' src="https://i.ibb.co.com/Xkjfq992/doctor-sample.png" alt="image" />
            </div>
        </div>
    );
};
