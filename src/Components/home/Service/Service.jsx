...
const Service = () => {
    return (
        <div className='text-center space-y-4 py-20'>
            ...
            <div className='w-10/12 mx-auto my-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                <div className='flex flex-col gap-2 p-10 items-center justify-start text-center bg-white rounded-lg'>
                    ...
                    <p className='text-3xl font-bold '> <CountUp className='text-3xl font-bold '
                    end={467}
                    duration={3}
                    />+</p>
                ...
                <div className='flex flex-col gap-2 p-10 items-center justify-start text-center bg-white rounded-lg'>
                    ...
                    duration={3}
                    />+</p>
                    <p className='text-[#0F0F0F60]'>Total Stuffs</p>
                </div>
            </div>
        </div>
    );
